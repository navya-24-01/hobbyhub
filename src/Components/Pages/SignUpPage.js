...
export default function SignUpPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    navigate("/profile", {
      state: { useremail: data.get("email"), password: data.get("password") },
    });
  };
              ...
              <div className="container px-4">
                ...
                <div className="row gx-5 justify-content-center">
                  <div className="col-xl-6 col-lg-8 text-center">
                    <form
                      className="row g-3 align-items-center mb-3 justify-content-center"
                    ...
                    >
                      ...
                      <div className="col-8">
                        <button
                          className="btn btn-teal fw-500 w-100"
                          type="submit"
                        >
                          Sign Up
                        </button>
