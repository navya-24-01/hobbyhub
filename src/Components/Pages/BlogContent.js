    ...
    <div id="layoutDefault">
      ...
      <main>
        <section className="bg-light py-10">
                ...
                <div className="single-post">
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-5">
                    <div className="single-post-meta me-4">
                      ...
                      <img className="single-post-meta-img" src={blog.authorProfilePic || 'path_to_default_image'} alt={blog.authorName} />
                      <div className="single-post-meta-details">
                        <div className="single-post-meta-details-name">{author}</div>
                        <div className="single-post-meta-details-date">{blog.date} &middot; {blog.readTime} min read</div>
                      </div>
                    </div>
          ...
          {/* Add your SVG or any other footer content here */}
